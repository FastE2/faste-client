...
//           <div className="w-full max-w-2xl rounded-2xl border border-gray-100 bg-white shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
//             {/* Header */}
...
//   return (
//     <Card className="flex flex-col justify-between hover:shadow-xl hover:scale-[1.02]">
//       {/* Header: Status */}
//       <div
...
//     .fill(0)
//     .map((_, i) => (
//       <Card key={i} className="h-[320px] p-5 space-y-3">
